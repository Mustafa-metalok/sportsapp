      ...
      <View style={styles.gapContainer}>
        <View style={styles.enterAmountContainer}>
          <View style={styles.enterAmountTextContainer}>
            <Text style={styles.enterAmountText}>From</Text>
            <Text style={styles.avblText}>Avbl : 30,000 RSVC</Text>
          </View>
          <View style={styles.usdtContainer}>
            <View style={styles.usdtImgTextContainer}>
              ...
              {/* </TouchableOpacity> */}
              <TouchableOpacity onPress={onPress}>
                <Text style={styles.usdtText}>RSVC</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={onPress}>
                <Image
          ...
          <View style={styles.highlightTextContainer}>
            <Text style={styles.highlightText}>1 RSVC = 21.02 PSVC</Text>
          </View>
        </View>

        <View style={styles.enterAmountContainer}>
          <View style={styles.enterAmountTextContainer}>
            <Text style={styles.enterAmountText}>To</Text>
          ...
          <View style={styles.usdtContainer}>
            <View style={styles.usdtImgTextContainer}>
              ...
              {/* </TouchableOpacity> */}
              <TouchableOpacity onPress={onPress}>
                <Text style={styles.usdtText}>PSVC</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={onPress}>
                <Image
                  source={require("../assets/icons/downMinor.png")}
