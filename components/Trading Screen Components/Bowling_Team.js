...
export default function Bowling_Team() {
  return (
    <View style={styles.parentContainer}>
      <View style={styles.mainContainer}>
        ...
        <View style={styles.matchTextContainer}>
          <TouchableOpacity onPress={onPress}>
            <View style={styles.matchTextViewContainer}>
              <Text style={styles.matchText}>MI vs CSK</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.mainContainer2}>
        <View style={styles.innerContainer}>
          ...
          <View style={styles.srhTextContainer}>
            <Text style={styles.srhText}>RCB</Text>
            <Text style={styles.srhBattingText}>Bowling</Text>
          </View>
        </View>
        <View style={styles.innerContainer2}>
          ...
          <View style={styles.valuesContainer}>
            <View style={styles.amountContainer}>
              <Image
                source={require('../../assets/icons/upgreen.png')}
                style={{
                  width: 15,
                  height: 20,
                }}
        ...
        <View style={styles.buyContainer}>
          <TouchableOpacity onPress={onPress}>
            <View style={styles.buyContainerView}>
              ...
              <Text style={styles.buyhsvcText}> BSVC</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
